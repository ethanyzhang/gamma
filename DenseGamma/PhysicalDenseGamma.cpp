...
/*
 * @file PhysicalDenseGamma.cpp
 * @author Yiqun Zhang <zhangyiqun9164@gmail.com>
 *
 * @brief Physical part of the DenseGamma SciDB operator.
 */
...
class PhysicalDenseGamma : public PhysicalOperator {
public:
  
  PhysicalDenseGamma(string const& logicalName,
...
REGISTER_PHYSICAL_OPERATOR_FACTORY(PhysicalDenseGamma, "DenseGamma", "PhysicalDenseGamma");
