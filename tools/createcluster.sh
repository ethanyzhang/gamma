...
echo "scidb" | $SCIDB_SOURCE_PATH/deployment/deploy.sh scidb_prepare $user "" $dbname $dbname $dbname /home/$user/scidbdata/$dbname $2 default `expr $1 - 1` default $hostlist
