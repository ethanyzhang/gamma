...
/*
 * @file LogicalSparseGamma.cpp
 * @author Yiqun Zhang <zhangyiqun9164@gmail.com>
 *
 * @brief Logical part of the SparseGamma SciDB operator.
 */
...
class LogicalSparseGamma : public LogicalOperator {
public:

  LogicalSparseGamma(const string& logicalName, const string& alias):
  ...
  ArrayDesc inferSchema(vector< ArrayDesc> schemas, shared_ptr< Query> query) {
    ...
    return ArrayDesc("SparseGamma_" + inputSchema.getName(), outputAttributes, outputDims, defaultPartitioning());
  }
};

REGISTER_LOGICAL_OPERATOR_FACTORY(LogicalSparseGamma, "SparseGamma");
