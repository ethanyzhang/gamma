...
/*
 * @file LogicalDiagSparseGamma.cpp
 * @author Yiqun Zhang <zhangyiqun9164@gmail.com>
 *
 * @brief Logical part of the DiagSparseGamma SciDB operator.
 */
...
class LogicalDiagSparseGamma : public LogicalOperator {
public:

  LogicalDiagSparseGamma(const string& logicalName, const string& alias):
  ...
  ArrayDesc inferSchema(vector< ArrayDesc> schemas, shared_ptr< Query> query) {
    ...
    return ArrayDesc("DiagSparseGamma_" + inputSchema.getName(), outputAttributes, outputDims, defaultPartitioning());
  }
};

REGISTER_LOGICAL_OPERATOR_FACTORY(LogicalDiagSparseGamma, "DiagSparseGamma");
